...
Категорії, навігація, сторінки категорій, sitemap і товарні зображення головної
будуються з відповідей CRM. Промо-тексти та редакційні бренд-блоки залишаються статичними.
