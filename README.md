...
підміни товарів мок-даними немає. Категорії, їхні URL, навігація та зображення товарів
на головній також надходять із CRM; статичними залишаються лише редакційні бренд-блоки.
