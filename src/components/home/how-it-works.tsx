...
const STEPS = [
  ...
  },
  {
    ...
    text: "Оформлюєте замовлення онлайн і безпечно оплачуєте карткою через Hutko.",
    when: "до дедлайну",
  },
  {
    icon: PlaneIcon,
    title: "Неділя — відправка з Мілана",
    text: "Забираємо всі замовлення тижня зі складу постачальника однією поставкою та веземо в Україну.",
    when: "щонеділі",
  },
  {
    icon: TruckIcon,
